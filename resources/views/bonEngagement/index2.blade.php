...
<div class="row g-3 mb-4 align-items-center justify-content-between">
    <div class="col-auto">
        <h1 class="app-page-title mb-0">BONS D'ENGAGEMENT</h1>
    </div>
    <div class="col-auto">
                    ...
                    <div class="table-responsive">
                        <table class="table app-table-hover mb-0 text-left">
                            ...
                            <tbody>
                                @forelse ($bons as $bon)
                                    <tr>
                                        ...
                                        <td class="cell"><!-- Nouvelle colonne pour le téléchargement PDF -->
                                            <center><a class="btn-sm app-btn-secondary" href="{{ route('bonEngagement.bonPDF', ['id' => $bon->id]) }}">
                                ...
                                @empty
                                    <tr>
                                        <td class="cell" colspan="9"><center>Aucun bon ajoute</center></td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
