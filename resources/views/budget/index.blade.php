                        ...
                        <tbody>
                            ...
                            @forelse ($budgets as $budget)
                                <tr>
                                    ...
                                    <td class="cell">
                                        <a class="btn-sm app-btn-secondary" href="{{route('budget.edit', $budget->id)}}">Editer</a>
                                        <a class="btn-sm app-btn-secondary" href="javascript:void(0);" 
                                        onclick="confirmDelete('{{ route('budget.delete', $budget->id) }}')">Supprimer</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td class="cell" colspan="2"><center>Aucun budget alloué</center></td>
                                </tr>
                            @endforelse
